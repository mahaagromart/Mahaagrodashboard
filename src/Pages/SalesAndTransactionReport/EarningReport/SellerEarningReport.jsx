...
import TotalSellerEarningTable from "../../../Component/Table/TotalSellerEarningTable";
  ...
  return (
    <>
      <Box marginTop="1%">
        <Box>
          <CardBox>
            <SimpleGrid columns={{ base: 1, md: 1, lg: 3 }} spacing={6} padding="10px">
